	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="<s:url value='Dashboard'/>"><img src="<s:url value='assets/images/SMA-logo.png'/>" alt=""></a>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="<s:url action='Logout'/>"><i class="icon-switch2"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
