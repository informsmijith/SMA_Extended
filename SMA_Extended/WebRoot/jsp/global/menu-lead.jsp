	...
	<div class="navbar navbar-default" id="navbar-second">
		...
		<div class="navbar-collapse collapse" id="navbar-second-toggle">
			<ul class="nav navbar-nav">
				<li class="active"><a href="index-2.html"><i class="icon-display4 position-left"></i> Dashboard</a></li>
									...
									<ul class="menu-list">
										<li>
											...
											<ul>
												...
												<li><a href="http://demo.interface.club/limitless/layout_4/RTL/index.html">RTL version <span class="label bg-danger-400">New</span></a></li>
											</ul>
										</li>
										<li>
										...
										<li>
											...
											<ul>
												...
												<li class="disabled"><a href="http://demo.interface.club/limitless/layout_5/LTR/index.html" id="layout5">Layout 5 <span class="label bg-slate-300">Coming soon</span></a></li>
											</ul>
										</li>
										<li>
